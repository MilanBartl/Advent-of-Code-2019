...
namespace AdventCode2019.Day17
{
    public class Worker : IWorker
    {
        ...
        private long CompInput()
        {
            if (inputIndex < source.Length)
                return source[inputIndex++];
            else
            {
                if (isMain)
                {
                ...
                {
                    isC = false;
                    source = Encoding.ASCII.GetBytes("n");
                }
